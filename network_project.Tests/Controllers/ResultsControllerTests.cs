...
//        [Fact]
//        public async Task GetQftResults_ThresholdClamp_Works()
//        {
...
//            var result = await controller.GetQftResults(0.5); // > 0.2
...
//                .ReturnsAsync(new List<dynamic>()) // first empty
//                .ReturnsAsync(new List<dynamic> { new() }); // fallback
